...
## Changelog
[2025-08-21]
- 변경: demo.html 고급 GA4 이벤트 추적 시스템 구현 완료
- 이유: Calendly 상호작용 세부 측정 필요 (뷰→시간선택→예약완료)
- 영향: 전환 퍼널 세밀 추적, 최적화 데이터 확보
- 다음: GA4에서 calendly_type_viewed, calendly_time_selected, schedule 이벤트 검증
